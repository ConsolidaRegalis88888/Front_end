...
import AuthRedirect from "./features/signin_detailes/presentation/Components/AuthRedirect";
import NewPassword from "./features/signin_detailes/presentation/Components/NewPassword";
    ...
    return (
        <div className="App">
            ...
            <Routes>
                ...
                <Route path="/main/authredirect" element={<AuthRedirect/>}/>
                <Route path="/main/newpassword" element={<NewPassword/>}/>
            </Routes>
        </div>
    );
}
