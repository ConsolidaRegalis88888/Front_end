...
export default class SinglePost extends Post
{
    ...
    constructor(idPost, mainTitle, dateOfPost, mainPostImage, postText1, titleInPost1, postText2, postText3, titleInPost2, postText4, postImage1, postImage2) {
        super(idPost, mainTitle, dateOfPost, mainPostImage);
