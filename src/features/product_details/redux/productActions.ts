...
export const productLoadedAction = (data: Product) => ({type: TYPE_PRODUCT_LOADER, payload: data});
export const productErrorAction = (message: string) => ({type: TYPE_PRODUCT_ERROR, payload: message});

export const productRecommendedLoadAction = () => ({type: TYPE_PRODUCT_RECOMMENDED_LOAD});
export const productRecommendedLoadedAction = (data: Array<ProductInList>) => ({type: TYPE_PRODUCT_RECOMMENDED_LOADED, payload: data});
export const productRecommendedErrorAction = (message: string) => ({type: TYPE_PRODUCT_RECOMMENDED_ERROR, payload: message});
